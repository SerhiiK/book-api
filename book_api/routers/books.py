...
from ..crud import delete_book_from_db, get_books, get_books_by_id, create_book_db, edit_the_book
...
@book.delete("/books/{book_id}", status_code=status.HTTP_204_NO_CONTENT,
